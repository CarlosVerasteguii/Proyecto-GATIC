<div class="container position-relative catalogs-form-page catalogs-suppliers-form-page">
    <x-ui.long-request target="save" />

    @php
        $pageTitle = $isEdit ? 'Editar proveedor' : 'Nuevo proveedor';
        $pageSubtitle = $isEdit
        ...
        $contactSummary = is_string($contact) && trim($contact) !== '' ? trim($contact) : 'Sin contacto';
        $notesSummary = is_string($notes) && trim($notes) !== '' ? 'Con notas' : 'Sin notas';
        $idSummary = $isEdit ? (string) $this->supplierId : 'Se asigna al guardar';
    @endphp
                ...
                <div class="card-header catalogs-form-card__header d-flex justify-content-between align-items-start gap-3 flex-wrap">
                    <div class="min-w-0">
                        <x-ui.breadcrumbs :items="[
                            ...
                            ['label' => 'Proveedores', 'url' => route('catalogs.suppliers.index')],
                ...
                <div class="card-body">
                    @if (! $isEdit && is_string($returnTo) && $returnTo !== '')
                        <div class="alert alert-info small" role="status">
                            Al guardar volverás al formulario anterior y el proveedor quedará seleccionado.
                        </div>
                    @endif
                            ...
                            <div class="col-12 col-xl-8">
                                <section class="catalogs-form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Ejemplo: Distribuciones…"
                                                    autocomplete="off"
                                                    maxlength="255"
                                                    required
                                                    autofocus
                                        ...
                                        <div class="col-12">
                                            <label for="supplier-contact" class="form-label">Contacto (opcional)</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-body">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Ej. Ventas: (55) 5555-0101…"
                                                    autocomplete="off"
                                                    maxlength="255"
                                                />
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <label for="supplier-notes" class="form-label">Notas (opcional)</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-body">
                            ...
                            <div class="col-12 col-xl-4">
                                <aside class="catalogs-form-summary">
                                    ...
                                    <div class="catalogs-form-summary__hint">
                                        <strong>Tip:</strong> Guarda un contacto directo para agilizar compras y seguimiento de garantías.
                                    </div>
                                </aside>
                            </div>
                        </div>
